            ...
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-2xl">
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea className="w-full mt-2 p-3 border rounded" placeholder="Suggestions" value={suggestion} onChange={(e) => setSuggestion(e.target.value)}></textarea>
                    </div>

                    <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg w-full transition">Submit</button>
                </form>
            </div>
        </div>
    );
